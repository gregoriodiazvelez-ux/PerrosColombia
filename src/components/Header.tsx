  ...
  return (
    <header className="relative overflow-hidden bg-gradient-to-r from-violet-950 via-purple-900 to-fuchsia-950 border-b border-purple-700/30">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -top-12 right-1/4 w-64 h-64 bg-fuchsia-500 rounded-full opacity-10 blur-3xl animate-pulse" style={{ animationDelay: "700ms" }} />
        <div className="absolute top-0 -right-12 w-80 h-80 bg-violet-400 rounded-full opacity-10 blur-3xl animate-pulse" style={{ animationDelay: "1000ms" }} />
      </div>
